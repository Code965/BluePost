...
function PersonalPage() {
  ...
  <div className='ProfilePageContainer flex_container align_center justify_content'>
    ...
    <div className='ProfilePageItems flex_container align_center justify_content '>
          ...
          <div className="autorSection flex_container align_center justify_content">
           <img className='foto' src={foto}/>
          
           <div className="info flex_container align_center justify_content">
            
           <div className='titlePrs'>
              <h1>{authState.username}</h1>
            </div>

              <div className='infPrs flex_container'>
              ...
              <div className='social flex_container align_center justify_content'>
                <li>
    ...
    <div className='ProfilePageItems flex_container align_center justify_content '>
      <h2> Articoli {utente.username}</h2>
    </div>
